        ...
        if ($laygrouptintuc->num_rows() > 0) {
            ...
            if ($chitiettintuc->num_rows() > 0) {
                ...
                <div class="breadcrumb">
                    <h2 style = "display:inline"><a class = "bread" href="<?php echo base_url(); ?>">Công ty dịch vụ vệ sinh</a></h2>
    ...
    <div class="ContentMain ">
        <div class="fixTopContent"></div>
            ...
            <div class="fixTopContent3">
                ...
                <div class="tagNews">
                    <p class="flLeft"><span class="fontsize13">Vệ sinh văn phòng công ty: </span>
                        <?php
            ...
            ?>
                <div class="service_other_left">
                    <div class="service_other_left_title">Tin dịch vụ liên quan</div>
                    <?php
        ...
        ?>
            <div class="tintuc_lienquan_right">
                <div  class="tintuc_lienquan_right_title" >Tin dịch vụ liên quan</div>
                <?php
