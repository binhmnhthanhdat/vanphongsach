...
$route['default_controller'] = "trangchu";
    ...
    $route['bang-gia-dich-vu-ve-sinh-cong-ty-van-phong'] = "gioithieu/banggia";
    $route['cong-ty'] = "gioithieu/index";
    $route['du-an'] = "duan/index";
     
	//begin rewwrite box tin ở đây thì anh chỉ thay url
    $route['meo-vat/(:any)'] = "tintuc/chitietdichvucongnghe/$1";//box 1
    $route['mon-ngon/(:any)'] = "tintuc/chitietkythuat/$1";//box 2
    $route['suc-khoe/(:any)'] = "tintuc/chitietcongnghemaytinh/$1";//box 3
      //end rewwrite box tin ở đây thì anh chỉ thay url
       ...
       //begin rewwrite box dich vu ở đây thì anh chỉ thay url
        $route['dich-vu-ve-sinh/(:any)'] = "tintuc/chitietthicongnoithat/$1";
        $route['ve-sinh-van-phong/(:any)'] = "tintuc/chitietthicongvanphong/$1";
        $route['giup-viec-theo-gio/(:any)'] = "tintuc/chitietthicongmang/$1";
        $route['ve-sinh-cong-nghiep/(:any)'] = "tintuc/chitietcongtynoithat/$1";
        $route['ve-sinh-dinh-ky/(:any)'] = "tintuc/chitietsuachuanhacua/$1";
        $route['ve-sinh-xay-dung/(:any)'] = "tintuc/chitietdichvusonnha/$1";
